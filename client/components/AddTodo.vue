<template>
    ...
    <div class="container w-25" style="margin-top: 70px;">
      <div class="text-center addTodo">
        <form class="form-addtodo" v-on:submit.prevent="saveAddTodo">
          <h1 class="h3 mb-3 font-weight-normal">Add Todo</h1>
          ...
          <button class="btn btn-lg btn-secondary btn-block" v-on:click.prevent="cancelAddTodo">Cancel</button>
