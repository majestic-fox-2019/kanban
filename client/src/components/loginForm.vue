  ...
  <div class="materialContainer">
    <div class="box">
      ...
      <div>
        ...
        <button
          ...
          style="margin-top: 15%;margin-left: 22%"
        >
    ...
    <div class="overbox">
      ...
      <div class="input">
        ...
        <input v-model="name" type="text" name="regname" id="regname" />
        <span class="spin"></span>
      </div>

      <div class="input">
        <label for="regmail">Email</label>
        <input v-model="email" type="email" name="regmail" id="regmail" />
        <span class="spin"></span>
      </div>

      <div class="input">
        <label for="regpass">Password</label>
        <input v-model="password" type="password" name="regpass" id="regpass" />
        <span class="spin"></span>
      </div>
