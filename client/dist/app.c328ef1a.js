...
},{}],"components/sidebar.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    addButton: function addButton() {
      if (this.inputadd == false) {
        return this.inputadd = true;
      } else {
        return this.inputadd = false;
      }
    }
  }
};
exports.default = _default;
        var $e95071 = exports.default || module.exports;
      
      if (typeof $e95071 === 'function') {
        $e95071 = $e95071.options;
      }
    
        /* template */
        Object.assign($e95071, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "sidebar-kanban" }, [
    _c("div", { staticClass: "text-kanban" }, [
      _c("h1", [_vm._v("KANBAN")]),
      _vm._v(" "),
      _c("p", [
        _vm._v(
          "Project management tool designed to help visualize work and maximize efficiency."
        )
      ]),
      _vm._v(" "),
      _c(
          ...
          "form",
          {
            on: {
              submit: function($event) {
                $event.preventDefault()
                return _vm.$emit("addtask", _vm.form)
              }
            }
          },
          [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e95071', $e95071);
          } else {
            api.reload('$e95071', $e95071);
          }
        }
...
},{}],"components/register.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $59357f = exports.default || module.exports;
      
      if (typeof $59357f === 'function') {
        $59357f = $59357f.options;
      }
    
        /* template */
        Object.assign($59357f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
      ...
      directives: [
        {
          name: "show",
          rawName: "v-show",
          value: _vm.registerpage,
          expression: "registerpage"
        }
      ]
    },
    [
      _c("h5", [_vm._v("REGISTRATION PAGE")]),
      _vm._v(" "),
      _c(
        "form",
        {
        ...
        [
          _c("div", { staticClass: "form-group" }, [
            ...
            _c("input", {
              ...
              attrs: { type: "text", id: "nameRegister", name: "nameRegister" },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$59357f', $59357f);
          } else {
            api.reload('$59357f', $59357f);
          }
        }
...
},{"axios":"node_modules/axios/index.js","vue-google-login":"node_modules/vue-google-login/dist/vue-google-login.min.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"components/login.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $040533 = exports.default || module.exports;
      
      if (typeof $040533 === 'function') {
        $040533 = $040533.options;
      }
    
        /* template */
        Object.assign($040533, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
      ...
      directives: [
        {
          ...
          rawName: "v-show",
          value: _vm.loginpage,
          expression: "loginpage"
        }
      ]
    },
    [
      _c("h5", [_vm._v("LOGIN PAGE")]),
      _vm._v(" "),
      _c(
        "form",
        {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$040533', $040533);
          } else {
            api.reload('$040533', $040533);
          }
        }
...
},{"vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"components/card.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    currentUser: function currentUser(task) {},
    nextStatus: function nextStatus(status) {
      if (status == "backlog") {
        this.getStatus = "todo";
      } else if (status == "todo") {
        this.getStatus = "done";
    ...
    backStatus: function backStatus(status) {
      if (status == "todo") {
...
exports.default = _default;
        var $e6ce0b = exports.default || module.exports;
      
      if (typeof $e6ce0b === 'function') {
        $e6ce0b = $e6ce0b.options;
      }
    
        /* template */
        Object.assign($e6ce0b, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    _vm._l(_vm.lists, function(list, index) {
      return _c("div", { key: index, staticClass: "all-task" }, [
        list.status === _vm.name
          ? _c("div", { staticClass: "task" }, [
              _c("p", [_vm._v(_vm._s(list.title))]),
              _vm._v(" "),
              _c("article", [_vm._v(_vm._s(list.description))]),
              _vm._v(" "),
              _vm.UserId == list.UserId
                    ...
                    _c("div", { staticClass: "backward" }, [
                      list.status !== "backlog"
                        ? _c("i", {
                            ...
                            on: {
                              click: function($event) {
                                _vm.backStatus(list.status)
                                _vm.$emit("updatetask", {
                                  list: list,
                                  getStatus: _vm.getStatus,
                                  index: index
                                })
                              }
                            }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e6ce0b', $e6ce0b);
          } else {
            api.reload('$e6ce0b', $e6ce0b);
          }
        }
...
},{"axios":"node_modules/axios/index.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"components/cardCategory.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $671c4e = exports.default || module.exports;
      
      if (typeof $671c4e === 'function') {
        $671c4e = $671c4e.options;
      }
    
        /* template */
        Object.assign($671c4e, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _c("div", { staticClass: "title" }, [
        _c("h4", [_vm._v(_vm._s(_vm.upperCase))])
      ]),
      _vm._v(" "),
      _c("card", {
        attrs: { lists: _vm.lists, name: _vm.name },
        on: {
          deletetask: function($event) {
            return _vm.$emit("deletetask", $event)
          },
          updatetask: function($event) {
            return _vm.$emit("updatetask", $event)
          }
        }
      })
    ],
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$671c4e', $671c4e);
          } else {
            api.reload('$671c4e', $671c4e);
          }
        }
...
},{"./card":"components/card.vue","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"components/homepage.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $7abf7d = exports.default || module.exports;
      
      if (typeof $7abf7d === 'function') {
        $7abf7d = $7abf7d.options;
      }
    
        /* template */
        Object.assign($7abf7d, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$7abf7d', $7abf7d);
          } else {
            api.reload('$7abf7d', $7abf7d);
          }
        }
...
var _cardCategory = _interopRequireDefault(require("./components/cardCategory"));
...
var _default = {
  ...
  methods: {
    gSignIn: function gSignIn(id_token) {
      ...
      (0, _axios.default)({
        method: "post",
        url: "".concat(server, "/login/google"),
        data: {
          id_token: id_token
        }
    ...
    loginUser: function loginUser(userLogin) {
      var _this3 = this;
    ...
    deleteTask: function deleteTask(task) {
      ...
      (0, _axios.default)({
        method: "delete",
        url: "".concat(server, "/task/").concat(task.list.id),
        headers: {
          token: localStorage.token
        }
      }).then(function (result) {
        var deletethis = result.data.status;

        _this6[deletethis].splice(task.index, 1);
      }).catch(function (err) {
        console.log(err);
      });
    },
    updateTask: function updateTask(task) {
      ...
      (0, _axios.default)({
        ...
        _this7[task.list.status].splice(task.index, 1);

        _this7[task.getStatus].push(result.data);
      }).catch(function (err) {
        console.log(err);
      });
    }
...
exports.default = _default;
        var $570a49 = exports.default || module.exports;
      
      if (typeof $570a49 === 'function') {
        $570a49 = $570a49.options;
      }
    
        /* template */
        Object.assign($570a49, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _vm.showsidebar
        ? _c(
            "div",
            { staticClass: "container-kanban" },
            [
              _c("sidebar", {
                on: { addtask: _vm.addTask, logOutButton: _vm.logOutButton }
              }),
              _vm._v(" "),
              _c(
                "div",
                ...
                [
                  _c("cardcategory", {
                    attrs: { lists: _vm.backlog, name: "backlog" },
                    on: {
                  ...
                  _vm._v(" "),
                  _c("cardcategory", {
                    attrs: { lists: _vm.todo, name: "todo" },
                    on: {
                      deletetask: _vm.deleteTask,
                      updatetask: _vm.updateTask
                    }
                  ...
                  _vm._v(" "),
                  _c("cardcategory", {
                    attrs: { lists: _vm.done, name: "done" },
                    on: {
                      deletetask: _vm.deleteTask,
                      updatetask: _vm.updateTask
                    }
                  ...
                  _vm._v(" "),
                  _c("cardcategory", {
                    attrs: { lists: _vm.complete, name: "complete" },
                    on: {
                      deletetask: _vm.deleteTask,
                      updatetask: _vm.updateTask
                    }
      ...
      _vm._v(" "),
      _c("homepage", {
        attrs: { registerpage: _vm.registerpage },
        on: {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$570a49', $570a49);
          } else {
            api.reload('$570a49', $570a49);
          }
        }
...
},{"axios":"node_modules/axios/index.js","./components/sidebar":"components/sidebar.vue","./components/register":"components/register.vue","./components/login":"components/login.vue","./components/cardCategory":"components/cardCategory.vue","./components/homepage":"components/homepage.vue","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"node_modules/vue-socket.io-extended/dist/vue-socket.io-ext.esm.js":[function(require,module,exports) {
"use strict";
...
},{"./debug":"node_modules/debug/src/debug.js","process":"node_modules/process/browser.js"}],"node_modules/socket.io-parser/node_modules/component-emitter/index.js":[function(require,module,exports) {
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"App.vue","vue-socket.io-extended":"node_modules/vue-socket.io-extended/dist/vue-socket.io-ext.esm.js","socket.io-client":"node_modules/socket.io-client/lib/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
