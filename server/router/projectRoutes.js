...
const { forProject, forIndividualTodo } = require("../middlewares/authorization")
...
routes.put("/todo/:idTodo", authentication, forIndividualTodo, controlProject.editTodoProject)


//delete todo project
// routes.delete("/todo/:idTodo", authentication, forProject, controlProject.deleteTodoProject)
routes.delete("/todo/:idTodo", authentication, forIndividualTodo, controlProject.deleteTodoProject)
